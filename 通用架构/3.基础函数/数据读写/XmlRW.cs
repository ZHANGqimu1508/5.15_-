...
namespace 通用架构._3.基础函数
{
    class XmlRW
    {
        ...
        public XmlRW()
        { }
        //string XMLFile = "C:/CameraSet/Parameters.xml";
        //string XMLPath = "C:/CameraSet/Parameters.xml";
        string XMLFile=AppDomain.CurrentDomain.BaseDirectory + @".//Parameters//Parameters.xml";
        string XMLPath = AppDomain.CurrentDomain.BaseDirectory + @".//Parameters//Parameters.xml";
        #endregion
