...
namespace 通用架构._3.基础函数
{
    public class CameraBasler
    {
        ...
        public HObject hPylonImage = null;
        ...
        public bool OpenCam()
        {
            try
            {
                ...
                imageHeight = camera.Parameters[PLCamera.Height].GetValue();
        ...
        /// 读取相机参数文件
        /// </summary>
        public bool ReadCameraParameter(string fileName)
        {
            try
            {
        ...
        public void SetROI(int x, int y, int width, int height)
        {
            try
            {
                ...
                camera.Parameters[PLCamera.Height].SetValue(height, IntegerValueCorrection.Nearest);
            }
            catch (Exception e)
            {
                ShowException(e);
